  ...
  return [
    {
      ...
      body: 'This space belongs to you. Everything saves automatically on this device and keeps working without the internet.', checklist: [], drawing: [], drawingHeight: 700, color: 'butter',
    ...
    },
    {
      ...
      body: 'Small notes compound into a life remembered.', checklist: [], drawing: [], drawingHeight: 700, color: 'lilac', pinned: false, favorite: false, archived: false, deletedAt: null, reminderAt: null,
